# -*- coding: utf-8 -*-
"""
Created on Thu Aug  6 15:40:00 2020
...
class Game():
    ...
    def drawSnake(self):
        for coord in self.snake.wormCoords:
            ...
            pygame.draw.rect(self.screen, Config.DARKGRAY, wormSegmentRect)
    ...
    def handleKeyEvents(self, event):
        if event.key == pygame.K_ESCAPE:
            ...
            self.snake.direction = self.snake.LEFT
              ...
              self.snake.direction != self.snake.LEFT):
            self.snake.direction = self.snake.RIGHT
        elif ((event.key == pygame.K_UP or event.key == pygame.K_w) and
    ...
    def isGameOver(self):
        ...
        for wormBody in self.snake.wormCoords[1:]:
            if (wormBody['x'] == self.snake.wormCoords[self.snake.HEAD]['x'] and
                wormBody['y'] == self.snake.wormCoords[self.snake.HEAD]['y']):
                return self.resetGame()
    ...
    def displayGameOver(self):
        ...
        #clear out any key press in in the event queue
    ...
    def showStartScreen(self):
        ...
        while True:
            ...
            rotatedSurf2 = pygame.transform.rotate(titleSurf2,
                                                   degrees2)
            ...
            degrees2 += 1# rotate by 7 degrees each frame
